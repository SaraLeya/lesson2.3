...
/*Задание 2*/
let solo = prompt('запишите в нее любое число');
if (solo>0 && solo<10) { 
    alert('yes');
} else {
    alert('no');
...
/*Задание 9*/
let clientOSi = prompt('Если вы пользуетесь iOS, то введите "0".Если вы пользуетесь Android, то введите "1".');
let clientDeviceYear = prompt('Введите год выпуска телефона');
clientDeviceYear = Number(clientDeviceYear);
clientOSi = Number(clientOS);
if (clientOSi === 1) {
